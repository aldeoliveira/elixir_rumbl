defmodule Rumbl.MultimediaTest do
  ...
  describe "categories" do
    test "list_alphabetical_categories/0" do
      for name <- ~w(Drama Action Comedy) do Multimedia.create_category!(name) end

      alpha_names = for %Category{name: name} <- Multimedia.list_alphabetical_categories() do name end
  ...
  describe "videos" do
    ...
    test "delete_videos/1 deletes the video" do
      owner = user_fixture()
      video = video_fixture(owner)
